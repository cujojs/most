(function (global, factory) {
  ...
  var prelude = createCommonjsModule(function (module, exports) {
  (function (global, factory) {
  ...
  var prelude$1 = interopDefault(prelude);
  var cons = prelude.cons;
  var append = prelude.append;
  var drop = prelude.drop;
  var tail = prelude.tail;
  var copy = prelude.copy;
  var map = prelude.map;
  var reduce = prelude.reduce;
  var replace = prelude.replace;
  var remove = prelude.remove;
  var removeAll = prelude.removeAll;
  var findIndex = prelude.findIndex;
  var isArrayLike = prelude.isArrayLike;
  var id = prelude.id;
  var compose = prelude.compose;
  var apply = prelude.apply;
  var curry2 = prelude.curry2;
  var curry3 = prelude.curry3;
...
var require$$0 = Object.freeze({
  ...
  function drain(stream) {
  	return runSource(stream.source);
  }
  ...
  Bound.prototype.event = noop$1;
  Bound.prototype.end = noop$1;
  Bound.prototype.dispose = noop$1;
  ...
  LowerBound.prototype.end = noop$1;
  ...
  UpperBound.prototype.end = noop$1;
  ...
  (function (global, factory) {
    if (typeof define === "function" && define.amd) {
      ...
      factory(exports, interopDefault(require$$0));
    } else {
      var mod = {
        exports: {}
      };
  ...
  })(commonjsGlobal, function (exports, _prelude) {
    'use strict';
  ...
  var multicast$1 = interopDefault(multicast);
