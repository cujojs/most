...
Stream.prototype.beget = function(step, state, dispose) {
	var disposeChild = typeof dispose === 'function' ? dispose : this.dispose;
	return new Stream(step, state, this.scheduler, disposeChild);
};
