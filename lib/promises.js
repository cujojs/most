...
/**
 * Create a promise whose fate is determined by the provided resolver function
 * @param {function(resolve:function(value:*), reject:function(e:Error)):void} resolver
 * @returns {Promise} new Promise
 */
function create(resolver) {
	return new WhenPromise(resolver);
}
