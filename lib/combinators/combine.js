...
function initAll (f, s) {
	...
	return traverse(getI, steps).then(function (is) {
...
function handleCombineStep(f, s, i, index) {
	...
	return traverse(getValue, nexts).then(function(iterations) {
